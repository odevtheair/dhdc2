...
-- ----------------------------
INSERT INTO `sys_version` VALUES ('20160302');
...
-- ----------------------------
-- Procedure structure for err_all_a
-- ----------------------------
DROP PROCEDURE IF EXISTS `err_all_a`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `err_all_a`()
BEGIN
call start_process;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `err_all_b`()
BEGIN
call start_process;
...
call err_anc_b(2559);
call err_charge_opd_b(2559);
call err_chronic_b(2559);
call err_chronicfu_b(2559);
call err_dental_b(2559);
call err_diagnosis_opd_b(2559);
call err_disability_b(2559);
call err_drugallergy_b(2559);
call err_drug_opd_b(2559);
call err_epi_b(2559);
call err_fp_b(2559);
call err_functional_b(2559);
call err_icf_b(2559);
call err_labfu_b(2559);
call err_labor_b(2559);
call err_ncdscreen_b(2559);
call err_newborn_b(2559);
call err_newborncare_b(2559);
call err_nutrition_b(2559);
call err_person_b(2559);
call err_postnatal_b(2559);
call err_prenatal_b(2559);
call err_procedure_opd_b(2559);
call err_provider_b(2559);
call err_rehabilitation_b(2559);
call err_service_b(2559);
call err_specialpp_b(2559);
call err_village_b(2559);
...
UPDATE sys_check_process t set t.fnc_name = 'err_anc_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_charge_opd_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_chronicfu_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_chronic_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_dental_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_diagnosis_opd_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_disability_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_drugallergy_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_drug_opd_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_epi_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_fp_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_functional_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_icf_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_labfu_b' , t.time = NOW();
...
UPDATE sys_check_process t set t.fnc_name = '' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_ncdscreen_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_newborncare_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_newborn_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_nutrition_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_person_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_postnatal_b' , t.time = NOW();
...
REPLACE INTO err_zall (
	...
	LEFT JOIN postnatal t on t.HOSPCODE = h.hoscode AND  (t.PPCARE BETWEEN @date1 	AND @date2)
	GROUP BY h.hoscode 
); # end insert
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_prenatal_b' , t.time = NOW();
...
REPLACE INTO err_zall (
	...
	LEFT JOIN prenatal t on t.HOSPCODE = h.hoscode AND  (t.LMP BETWEEN @date1 	AND @date2)
	GROUP BY h.hoscode 
); # end insert
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_procedure_opd_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_provider_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_rehabilitation_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_service_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_specialpp_b' , t.time = NOW();
...
BEGIN
	...
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_village_b' , t.time = NOW();
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `list_sp`()
BEGIN
...
BEGIN 
SELECT hos.hoscode,hos.hosname,p.CID,p.`NAME`,p.LNAME,p.SEX,p.BIRTH
,TIMESTAMPDIFF(MONTH,p.BIRTH,CURDATE()) as AGE_M,t.VACCINETYPE 
,t.DATE_SERV,if(t.DATE_SERV < '2015-12-01','ลงวันที่ฉีดก่อน 1ธค58','') as 'CHECK_DATE_SERV'
,if(t.VACCINETYPE is NULL,if(TIMESTAMPDIFF(MONTH,p.BIRTH,CURDATE())>=4,'3-ถึงเวลาฉีด','2-รอครบ4ด.'),'1-ฉีดแล้ว') as 'NEED_VACC' 
,p.DISCHARGE
FROM person p
LEFT JOIN (SELECT * FROM epi_cid e WHERE e.VACCINETYPE = '401') t on t.CID = p.CID
LEFT JOIN chospital_amp hos on hos.hoscode = p.HOSPCODE
WHERE p.BIRTH > '2015-08-01' AND '2016-05-31' AND p.TYPEAREA in (1,3)
ORDER by p.HOSPCODE ASC;
 END
;;
DELIMITER ;

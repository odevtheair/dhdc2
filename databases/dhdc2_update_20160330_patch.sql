...
-- ----------------------------
-- Table structure for dhdc_tmp_accident
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_accident`;
CREATE TABLE `dhdc_tmp_accident` (
  ...
  KEY `idx2` (`DATETIME_SERV`) USING BTREE,
  KEY `idx3` (`DATETIME_AE`) USING BTREE,
  KEY `idx4` (`HOSPCODE`) USING BTREE,
  KEY `idx5` (`AETYPE`) USING BTREE,
  KEY `idx6` (`AEPLACE`) USING BTREE,
  KEY `idx7` (`TYPEIN_AE`) USING BTREE,
  KEY `idx8` (`TRAFFIC`) USING BTREE,
  KEY `idx9` (`VEHICLE`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_accident
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_address
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_address`;
CREATE TABLE `dhdc_tmp_address` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  ...
  KEY `idx1` (`CHANGWAT`) USING BTREE,
  KEY `idx2` (`CHANGWAT`,`AMPUR`) USING BTREE,
  KEY `idx3` (`CHANGWAT`,`AMPUR`,`TAMBON`) USING BTREE,
  KEY `idx4` (`CHANGWAT`,`AMPUR`,`TAMBON`,`VILLAGE`) USING BTREE,
  KEY `idx5` (`HOSPCODE`,`PID`) USING BTREE,
  KEY `idx6` (`HOSPCODE`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_address
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_admission
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_admission`;
CREATE TABLE `dhdc_tmp_admission` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) NOT NULL,
  ...
  KEY `idx1` (`HOSPCODE`,`PID`) USING BTREE,
  KEY `idx2` (`DATETIME_ADMIT`) USING BTREE,
  KEY `idx3` (`HOSPCODE`,`PROVIDER`) USING BTREE,
  KEY `idx4` (`HOSPCODE`) USING BTREE,
  KEY `idx5` (`INSTYPE`) USING BTREE,
  KEY `idx6` (`TYPEIN`) USING BTREE,
  KEY `idx7` (`REFERINHOSP`) USING BTREE,
  KEY `idx8` (`DATETIME_DISCH`) USING BTREE,
  KEY `idx9` (`DISCHSTATUS`) USING BTREE,
  KEY `idx10` (`DISCHTYPE`) USING BTREE,
  KEY `idx11` (`REFEROUTHOSP`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_admission
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_anc
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_anc`;
CREATE TABLE `dhdc_tmp_anc` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  ...
  KEY `idx1` (`HOSPCODE`,`PID`) USING BTREE,
  KEY `idx2` (`GRAVIDA`) USING BTREE,
  KEY `idx3` (`ANCNO`) USING BTREE,
  KEY `idx4` (`GA`) USING BTREE,
  KEY `idx5` (`ANCRESULT`) USING BTREE,
  KEY `idx6` (`ANCPLACE`) USING BTREE,
  KEY `idx7` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_anc
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_appointment
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_appointment`;
CREATE TABLE `dhdc_tmp_appointment` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
...
-- ----------------------------
-- Records of dhdc_tmp_appointment
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_cancer
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_cancer`;
CREATE TABLE `dhdc_tmp_cancer` (
...
-- ----------------------------
-- Records of dhdc_tmp_cancer
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_card
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_card`;
CREATE TABLE `dhdc_tmp_card` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
...
-- ----------------------------
-- Records of dhdc_tmp_card
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_care_refer
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_care_refer`;
CREATE TABLE `dhdc_tmp_care_refer` (
  `HOSPCODE` varchar(5) NOT NULL,
  ...
  KEY `idx1` (`HOSPCODE`) USING BTREE,
  KEY `idx2` (`HOSPCODE`,`REFERID`) USING BTREE,
  KEY `idx3` (`REFERID_PROVINCE`) USING BTREE,
  KEY `idx4` (`CARETYPE`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_care_refer
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_charge_ipd
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_charge_ipd`;
CREATE TABLE `dhdc_tmp_charge_ipd` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `AN` varchar(9) NOT NULL,
  `DATETIME_ADMIT` datetime NOT NULL,
  ...
  KEY `idx1` (`HOSPCODE`,`PID`) USING BTREE,
  KEY `idx2` (`AN`) USING BTREE,
  KEY `idx3` (`DATETIME_ADMIT`) USING BTREE,
  KEY `idx4` (`WARDSTAY`) USING BTREE,
  KEY `idx5` (`CHARGEITEM`) USING BTREE,
  KEY `idx6` (`CHARGELIST`) USING BTREE,
  KEY `idx7` (`INSTYPE`) USING BTREE,
  KEY `idx8` (`COST`) USING BTREE,
  KEY `idx9` (`PRICE`) USING BTREE,
  KEY `idx10` (`HOSPCODE`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_charge_ipd
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_charge_opd
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_charge_opd`;
CREATE TABLE `dhdc_tmp_charge_opd` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) NOT NULL,
  `DATE_SERV` date NOT NULL,
  ...
  KEY `idx3` (`CHARGEITEM`) USING BTREE,
  KEY `idx4` (`CHARGELIST`) USING BTREE,
  KEY `idx5` (`INSTYPE`) USING BTREE,
  KEY `idx6` (`COST`) USING BTREE,
  KEY `idx7` (`PRICE`) USING BTREE,
  KEY `idx8` (`HOSPCODE`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_charge_opd
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_chronic
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_chronic`;
CREATE TABLE `dhdc_tmp_chronic` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  ...
  KEY `idx1` (`HOSPCODE`,`PID`) USING BTREE,
  KEY `idx2` (`CHRONIC`) USING BTREE,
  KEY `idx3` (`DATE_DIAG`) USING BTREE,
  KEY `idx4` (`HOSP_DX`) USING BTREE,
  KEY `idx5` (`HOSP_RX`) USING BTREE,
  KEY `idx6` (`DATE_DISCH`) USING BTREE,
  KEY `idx7` (`TYPEDISCH`) USING BTREE,
  KEY `idx8` (`HOSPCODE`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_chronic
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_chronicfu
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_chronicfu`;
CREATE TABLE `dhdc_tmp_chronicfu` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) NOT NULL,
  `DATE_SERV` date NOT NULL,
  ...
  KEY `idx3` (`DATE_SERV`) USING BTREE,
  KEY `idx4` (`WEIGHT`) USING BTREE,
  KEY `idx5` (`HEIGHT`) USING BTREE,
  KEY `idx6` (`WAIST_CM`) USING BTREE,
  KEY `idx7` (`SBP`) USING BTREE,
  KEY `idx8` (`DBP`) USING BTREE,
  KEY `idx9` (`FOOT`) USING BTREE,
  KEY `idx10` (`RETINA`) USING BTREE,
  KEY `idx11` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_chronicfu
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_clinical_refer
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_clinical_refer`;
CREATE TABLE `dhdc_tmp_clinical_refer` (
  `HOSPCODE` varchar(5) NOT NULL,
  `REFERID` varchar(10) NOT NULL,
  `REFERID_PROVINCE` varchar(10) DEFAULT NULL,
  ...
  KEY `idx2` (`HOSPCODE`,`REFERID`) USING BTREE,
  KEY `idx3` (`REFERID_PROVINCE`) USING BTREE,
  KEY `idx4` (`CLINICALCODE`) USING BTREE,
  KEY `idx5` (`CLINICALCODE`,`CLINICALVAULE`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_clinical_refer
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_community_activity
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_community_activity`;
CREATE TABLE `dhdc_tmp_community_activity` (
  `HOSPCODE` varchar(5) NOT NULL,
  ...
  KEY `idx1` (`HOSPCODE`,`VID`) USING BTREE,
  KEY `idx2` (`DATE_START`) USING BTREE,
  KEY `idx3` (`DATE_FINISH`) USING BTREE,
  KEY `idx4` (`COMACTIVITY`) USING BTREE,
  KEY `idx5` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_community_activity
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_community_service
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_community_service`;
CREATE TABLE `dhdc_tmp_community_service` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) NOT NULL,
  `DATE_SERV` date NOT NULL,
  ...
  KEY `idx2` (`HOSPCODE`) USING BTREE,
  KEY `idx3` (`DATE_SERV`) USING BTREE,
  KEY `idx4` (`COMSERVICE`) USING BTREE,
  KEY `idx5` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_community_service
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_dataupdate
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_dataupdate`;
CREATE TABLE `dhdc_tmp_dataupdate` (
  `hospcode` varchar(5) DEFAULT NULL,
  `tablename` varchar(255) DEFAULT NULL,
  `values_pk` varchar(255) DEFAULT NULL,
  `values_set` varchar(255) DEFAULT NULL,
  `d_update` datetime DEFAULT NULL,
  `NOTE1` varchar(255) DEFAULT NULL,
  `NOTE2` varchar(255) DEFAULT NULL,
  `NOTE3` varchar(255) DEFAULT NULL,
...
-- ----------------------------
-- Records of dhdc_tmp_dataupdate
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_data_delete
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_data_delete`;
CREATE TABLE `dhdc_tmp_data_delete` (
  `HOSPCODE` varchar(5) NOT NULL,
...
-- ----------------------------
-- Records of dhdc_tmp_data_delete
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_death
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_death`;
CREATE TABLE `dhdc_tmp_death` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
...
-- ----------------------------
-- Records of dhdc_tmp_death
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_dental
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_dental`;
CREATE TABLE `dhdc_tmp_dental` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) NOT NULL,
  `DATE_SERV` date NOT NULL,
  ...
  KEY `idx2` (`HOSPCODE`) USING BTREE,
  KEY `idx3` (`DATE_SERV`) USING BTREE,
  KEY `idx4` (`DENTTYPE`) USING BTREE,
  KEY `idx5` (`CLASS`) USING BTREE,
  KEY `idx7` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_dental
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_diagnosis_ipd
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_diagnosis_ipd`;
CREATE TABLE `dhdc_tmp_diagnosis_ipd` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `AN` varchar(9) NOT NULL,
  `DATETIME_ADMIT` datetime NOT NULL,
  ...
  KEY `idx2` (`HOSPCODE`) USING BTREE,
  KEY `idx3` (`DATETIME_ADMIT`) USING BTREE,
  KEY `idx4` (`DIAGTYPE`) USING BTREE,
  KEY `idx5` (`DIAGCODE`) USING BTREE,
  KEY `idx6` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_diagnosis_ipd
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_diagnosis_opd
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_diagnosis_opd`;
CREATE TABLE `dhdc_tmp_diagnosis_opd` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) NOT NULL,
  `DATE_SERV` date NOT NULL,
  ...
  KEY `idx4` (`DIAGTYPE`) USING BTREE,
  KEY `idx5` (`DIAGCODE`) USING BTREE,
  KEY `idx6` (`CLINIC`) USING BTREE,
  KEY `idx7` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_diagnosis_opd
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_disability
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_disability`;
CREATE TABLE `dhdc_tmp_disability` (
  `HOSPCODE` varchar(5) NOT NULL,
  ...
  KEY `idx1` (`HOSPCODE`,`PID`) USING BTREE,
  KEY `idx2` (`HOSPCODE`,`DISABID`) USING BTREE,
  KEY `idx3` (`HOSPCODE`) USING BTREE,
  KEY `idx4` (`DISABTYPE`) USING BTREE,
  KEY `idx5` (`DISABCAUSE`) USING BTREE,
  KEY `idx6` (`DIAGCODE`) USING BTREE,
  KEY `idx7` (`DATE_DETECT`) USING BTREE,
  KEY `idx8` (`DATE_DISAB`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_disability
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_drugallergy
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_drugallergy`;
CREATE TABLE `dhdc_tmp_drugallergy` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  ...
  KEY `idx1` (`HOSPCODE`,`PID`) USING BTREE,
  KEY `idx3` (`HOSPCODE`) USING BTREE,
  KEY `idx5` (`DRUGALLERGY`) USING BTREE,
  KEY `idx6` (`TYPEDX`) USING BTREE,
  KEY `idx7` (`ALEVEL`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_drugallergy
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_drug_ipd
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_drug_ipd`;
CREATE TABLE `dhdc_tmp_drug_ipd` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `AN` varchar(9) NOT NULL,
  `DATETIME_ADMIT` datetime NOT NULL,
  ...
  KEY `idx3` (`DATETIME_ADMIT`) USING BTREE,
  KEY `idx4` (`WARDSTAY`) USING BTREE,
  KEY `idx5` (`TYPEDRUG`) USING BTREE,
  KEY `idx6` (`DIDSTD`) USING BTREE,
  KEY `idx7` (`DATESTART`) USING BTREE,
  KEY `idx8` (`DATEFINISH`) USING BTREE,
  KEY `idx9` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_drug_ipd
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_drug_opd
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_drug_opd`;
CREATE TABLE `dhdc_tmp_drug_opd` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) NOT NULL,
  `DATE_SERV` date NOT NULL,
  ...
  KEY `idx2` (`DATE_SERV`) USING BTREE,
  KEY `idx3` (`HOSPCODE`) USING BTREE,
  KEY `idx4` (`DIDSTD`) USING BTREE,
  KEY `idx5` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_drug_opd
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_drug_refer
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_drug_refer`;
CREATE TABLE `dhdc_tmp_drug_refer` (
  `HOSPCODE` varchar(5) NOT NULL,
  `REFERID` varchar(10) NOT NULL,
  `REFERID_PROVINCE` varchar(10) DEFAULT NULL,
  ...
  KEY `idx2` (`HOSPCODE`,`REFERID`) USING BTREE,
  KEY `idx3` (`REFERID_PROVINCE`) USING BTREE,
  KEY `idx4` (`DATETIME_DSTART`) USING BTREE,
  KEY `idx5` (`DIDSTD`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_drug_refer
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_epi
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_epi`;
CREATE TABLE `dhdc_tmp_epi` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) DEFAULT NULL,
  `DATE_SERV` date NOT NULL,
  ...
  KEY `idx1` (`HOSPCODE`,`PID`) USING BTREE,
  KEY `idx2` (`HOSPCODE`) USING BTREE,
  KEY `idx3` (`VACCINETYPE`) USING BTREE,
  KEY `idx4` (`VACCINEPLACE`) USING BTREE,
  KEY `idx5` (`HOSPCODE`,`PROVIDER`) USING BTREE,
  KEY `idx6` (`DATE_SERV`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_epi
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_fp
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_fp`;
CREATE TABLE `dhdc_tmp_fp` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) DEFAULT NULL,
  `DATE_SERV` date NOT NULL,
  ...
  KEY `idx2` (`HOSPCODE`) USING BTREE,
  KEY `idx3` (`DATE_SERV`) USING BTREE,
  KEY `idx4` (`FPTYPE`) USING BTREE,
  KEY `idx5` (`FPPLACE`) USING BTREE,
  KEY `idx6` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_fp
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_functional
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_functional`;
CREATE TABLE `dhdc_tmp_functional` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) NOT NULL,
  `DATE_SERV` date NOT NULL,
  ...
  KEY `idx2` (`HOSPCODE`) USING BTREE,
  KEY `idx3` (`DATE_SERV`) USING BTREE,
  KEY `idx4` (`FUNCTIONAL_TEST`) USING BTREE,
  KEY `idx6` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_functional
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_home
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_home`;
CREATE TABLE `dhdc_tmp_home` (
  `HOSPCODE` varchar(5) NOT NULL,
  ...
  KEY `idx1` (`HOSPCODE`,`HID`) USING BTREE,
  KEY `idx2` (`CHANGWAT`) USING BTREE,
  KEY `idx3` (`CHANGWAT`,`AMPUR`) USING BTREE,
  KEY `idx4` (`CHANGWAT`,`AMPUR`,`TAMBON`) USING BTREE,
  KEY `idx5` (`CHANGWAT`,`AMPUR`,`TAMBON`,`VILLAGE`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_home
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_icf
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_icf`;
CREATE TABLE `dhdc_tmp_icf` (
  `HOSPCODE` varchar(5) NOT NULL,
  `DISABID` varchar(13) DEFAULT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) NOT NULL,
...
-- ----------------------------
-- Records of dhdc_tmp_icf
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_investigation_refer
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_investigation_refer`;
CREATE TABLE `dhdc_tmp_investigation_refer` (
  `HOSPCODE` varchar(5) NOT NULL,
  `REFERID` varchar(10) NOT NULL,
  `REFERID_PROVINCE` varchar(10) DEFAULT NULL,
  ...
  KEY `idx2` (`HOSPCODE`,`REFERID`) USING BTREE,
  KEY `idx3` (`REFERID_PROVINCE`) USING BTREE,
  KEY `idx4` (`INVESTCODE`) USING BTREE,
  KEY `idx5` (`DATETIME_INVEST`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_investigation_refer
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_labfu
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_labfu`;
CREATE TABLE `dhdc_tmp_labfu` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) NOT NULL,
  `DATE_SERV` date NOT NULL,
  ...
  KEY `idx2` (`HOSPCODE`) USING BTREE,
  KEY `idx3` (`DATE_SERV`) USING BTREE,
  KEY `idx4` (`LABTEST`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_labfu
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_labor
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_labor`;
CREATE TABLE `dhdc_tmp_labor` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `GRAVIDA` varchar(2) NOT NULL,
  `LMP` date NOT NULL,
  ...
  KEY `idx1` (`HOSPCODE`,`PID`) USING BTREE,
  KEY `idx2` (`HOSPCODE`) USING BTREE,
  KEY `idx3` (`GRAVIDA`) USING BTREE,
  KEY `idx4` (`BDATE`) USING BTREE,
  KEY `idx5` (`BRESULT`) USING BTREE,
  KEY `idx6` (`BHOSP`) USING BTREE,
  KEY `idx7` (`BDOCTOR`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_labor
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_ncdscreen
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_ncdscreen`;
CREATE TABLE `dhdc_tmp_ncdscreen` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) DEFAULT NULL,
  `DATE_SERV` date NOT NULL,
  ...
  KEY `idx2` (`HOSPCODE`) USING BTREE,
  KEY `idx3` (`DATE_SERV`) USING BTREE,
  KEY `idx4` (`SBP_1`,`DBP_1`) USING BTREE,
  KEY `idx5` (`SBP_2`,`DBP_2`) USING BTREE,
  KEY `idx6` (`BSLEVEL`) USING BTREE,
  KEY `idx7` (`BSTEST`) USING BTREE,
  KEY `idx8` (`SCREENPLACE`) USING BTREE,
  KEY `idx9` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_ncdscreen
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_newborn
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_newborn`;
CREATE TABLE `dhdc_tmp_newborn` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  ...
  PRIMARY KEY (`HOSPCODE`,`PID`),
  KEY `idx1` (`HOSPCODE`,`PID`) USING BTREE,
  KEY `idx2` (`HOSPCODE`,`MPID`) USING BTREE,
  KEY `idx3` (`HOSPCODE`) USING BTREE,
  KEY `idx4` (`MPID`) USING BTREE,
  KEY `idx5` (`BDATE`) USING BTREE,
  KEY `idx6` (`BHOSP`) USING BTREE,
  KEY `idx7` (`BWEIGHT`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_newborn
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_newborncare
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_newborncare`;
CREATE TABLE `dhdc_tmp_newborncare` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) DEFAULT NULL,
  `BDATE` date NOT NULL,
  ...
  KEY `idx1` (`HOSPCODE`,`PID`) USING BTREE,
  KEY `idx2` (`HOSPCODE`) USING BTREE,
  KEY `idx3` (`BDATE`) USING BTREE,
  KEY `idx4` (`BCARE`) USING BTREE,
  KEY `idx5` (`BCPLACE`) USING BTREE,
  KEY `idx6` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_newborncare
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_newborn_care
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_newborn_care`;
CREATE TABLE `dhdc_tmp_newborn_care` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) DEFAULT NULL,
  `BDATE` date NOT NULL,
...
-- ----------------------------
-- Records of dhdc_tmp_newborn_care
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_nutrition
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_nutrition`;
CREATE TABLE `dhdc_tmp_nutrition` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) DEFAULT NULL,
  `DATE_SERV` date NOT NULL,
  ...
  KEY `idx2` (`HOSPCODE`) USING BTREE,
  KEY `idx3` (`DATE_SERV`) USING BTREE,
  KEY `idx4` (`NUTRITIONPLACE`) USING BTREE,
  KEY `idx5` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_nutrition
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_person
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_person`;
CREATE TABLE `dhdc_tmp_person` (
  `HOSPCODE` varchar(5) NOT NULL,
  ...
  `NOTE4` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`HOSPCODE`,`PID`),
  KEY `idx_hoscode` (`HOSPCODE`,`PID`,`TYPEAREA`) USING BTREE,
  KEY `idx1` (`HOSPCODE`) USING BTREE,
  KEY `idx2` (`CID`) USING BTREE,
  KEY `idx3` (`HID`) USING BTREE,
  KEY `idx4` (`TYPEAREA`) USING BTREE,
  KEY `idx5` (`TYPEAREA`) USING BTREE,
  KEY `idx6` (`HOSPCODE`,`PID`) USING BTREE,
  KEY `idx7` (`BIRTH`) USING BTREE,
  KEY `idx8` (`DISCHARGE`) USING BTREE,
  KEY `idx9` (`LABOR`) USING BTREE,
  KEY `idx10` (`HOSPCODE`,`HID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_person
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_postnatal
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_postnatal`;
CREATE TABLE `dhdc_tmp_postnatal` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) DEFAULT NULL,
  `GRAVIDA` varchar(2) NOT NULL,
  ...
  KEY `idx2` (`HOSPCODE`) USING BTREE,
  KEY `idx3` (`BDATE`) USING BTREE,
  KEY `idx4` (`GRAVIDA`) USING BTREE,
  KEY `idx5` (`PPCARE`) USING BTREE,
  KEY `idx6` (`PPPLACE`) USING BTREE,
  KEY `idx7` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_postnatal
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_prenatal
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_prenatal`;
CREATE TABLE `dhdc_tmp_prenatal` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `GRAVIDA` varchar(2) NOT NULL,
  `LMP` date NOT NULL,
...
-- ----------------------------
-- Records of dhdc_tmp_prenatal
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_procedure_ipd
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_procedure_ipd`;
CREATE TABLE `dhdc_tmp_procedure_ipd` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `AN` varchar(9) NOT NULL,
  `DATETIME_ADMIT` datetime NOT NULL,
  ...
  KEY `idx2` (`HOSPCODE`) USING BTREE,
  KEY `idx3` (`DATETIME_ADMIT`) USING BTREE,
  KEY `idx4` (`PROCEDCODE`) USING BTREE,
  KEY `idx5` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_procedure_ipd
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_procedure_opd
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_procedure_opd`;
CREATE TABLE `dhdc_tmp_procedure_opd` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) NOT NULL,
  `DATE_SERV` date NOT NULL,
...
-- ----------------------------
-- Records of dhdc_tmp_procedure_opd
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_procedure_refer
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_procedure_refer`;
CREATE TABLE `dhdc_tmp_procedure_refer` (
  `HOSPCODE` varchar(5) NOT NULL,
  `REFERID` varchar(10) NOT NULL,
  `REFERID_PROVINCE` varchar(10) DEFAULT NULL,
  `TIMESTART` datetime NOT NULL,
  ...
  KEY `idx2` (`HOSPCODE`,`REFERID`) USING BTREE,
  KEY `idx3` (`REFERID_PROVINCE`) USING BTREE,
  KEY `idx4` (`TIMESTART`) USING BTREE,
  KEY `idx5` (`PROCEDCODE`) USING BTREE,
  KEY `idx6` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_procedure_refer
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_provider
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_provider`;
CREATE TABLE `dhdc_tmp_provider` (
  `HOSPCODE` varchar(5) NOT NULL,
...
-- ----------------------------
-- Records of dhdc_tmp_provider
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_refer_history
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_refer_history`;
CREATE TABLE `dhdc_tmp_refer_history` (
  `HOSPCODE` varchar(5) NOT NULL,
  `REFERID` varchar(10) NOT NULL,
  `REFERID_PROVINCE` varchar(10) DEFAULT NULL,
  `PID` varchar(15) NOT NULL,
  ...
  KEY `idx2` (`HOSPCODE`,`REFERID`) USING BTREE,
  KEY `idx3` (`REFERID_PROVINCE`) USING BTREE,
  KEY `idx4` (`HOSPCODE`,`PID`) USING BTREE,
  KEY `idx5` (`HOSPCODE`,`PID`,`SEQ`) USING BTREE,
  KEY `idx6` (`HOSPCODE`,`PID`,`AN`) USING BTREE,
  KEY `idx7` (`REFERID_ORIGIN`,`HOSPCODE_ORIGIN`) USING BTREE,
  KEY `idx8` (`DATETIME_SERV`) USING BTREE,
  KEY `idx9` (`DATETIME_ADMIT`) USING BTREE,
  KEY `idx10` (`DATETIME_REFER`) USING BTREE,
  KEY `idx11` (`CAUSEOUT`) USING BTREE,
  KEY `idx12` (`PTYPEDIS`) USING BTREE,
  KEY `idx13` (`EMERGENCY`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_refer_history
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_refer_result
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_refer_result`;
CREATE TABLE `dhdc_tmp_refer_result` (
  `HOSPCODE` varchar(5) NOT NULL,
  ...
  KEY `idx1` (`HOSPCODE`) USING BTREE,
  KEY `idx2` (`HOSPCODE`,`REFERID_SOURCE`) USING BTREE,
  KEY `idx3` (`REFERID_PROVINCE`) USING BTREE,
  KEY `idx4` (`HOSP_SOURCE`) USING BTREE,
  KEY `idx5` (`REFER_RESULT`) USING BTREE,
  KEY `idx6` (`DATETIME_IN`) USING BTREE,
  KEY `idx7` (`HOSPCODE`,`PID_IN`) USING BTREE,
  KEY `idx8` (`HOSPCODE`,`AN_IN`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_refer_result
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_rehabilitation
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_rehabilitation`;
CREATE TABLE `dhdc_tmp_rehabilitation` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) DEFAULT NULL,
  `AN` varchar(9) DEFAULT NULL,
  ...
  KEY `idx1` (`HOSPCODE`,`PID`) USING BTREE,
  KEY `idx2` (`HOSPCODE`) USING BTREE,
  KEY `idx3` (`DATE_ADMIT`) USING BTREE,
  KEY `idx10` (`DATE_SERV`) USING BTREE,
  KEY `idx4` (`HOSPCODE`,`AN`) USING BTREE,
  KEY `idx5` (`REHABCODE`) USING BTREE,
  KEY `idx6` (`AT_DEVICE`) USING BTREE,
  KEY `idx7` (`REHABPLACE`) USING BTREE,
  KEY `idx8` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_rehabilitation
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_school
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_school`;
CREATE TABLE `dhdc_tmp_school` (
  `HOSPCODE` varchar(5) NOT NULL DEFAULT '',
...
-- ----------------------------
-- Records of dhdc_tmp_school
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_service
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_service`;
CREATE TABLE `dhdc_tmp_service` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `HN` varchar(15) DEFAULT NULL,
  `SEQ` varchar(16) NOT NULL,
...
-- ----------------------------
-- Records of dhdc_tmp_service
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_specialpp
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_specialpp`;
CREATE TABLE `dhdc_tmp_specialpp` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) DEFAULT NULL,
  `DATE_SERV` date NOT NULL,
...
-- ----------------------------
-- Records of dhdc_tmp_specialpp
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_student
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_student`;
CREATE TABLE `dhdc_tmp_student` (
  `HOSPCODE` varchar(5) NOT NULL DEFAULT '',
  `PID` varchar(15) NOT NULL DEFAULT '',
  `SCHOOLCODE` varchar(9) NOT NULL DEFAULT '',
...
-- ----------------------------
-- Records of dhdc_tmp_student
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_surveillance
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_surveillance`;
CREATE TABLE `dhdc_tmp_surveillance` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
  `SEQ` varchar(16) NOT NULL,
  `DATE_SERV` date NOT NULL,
  ...
  KEY `idx2` (`HOSPCODE`) USING BTREE,
  KEY `idx3` (`DATE_SERV`) USING BTREE,
  KEY `idx4` (`DATETIME_ADMIT`) USING BTREE,
  KEY `idx5` (`DIAGCODE`) USING BTREE,
  KEY `idx6` (`CODE506`) USING BTREE,
  KEY `idx7` (`DIAGCODELAST`) USING BTREE,
  KEY `idx8` (`CODE506LAST`) USING BTREE,
  KEY `idx9` (`ILLDATE`) USING BTREE,
  KEY `idx10` (`HOSPCODE`,`PROVIDER`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dhdc_tmp_surveillance
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_village
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_village`;
CREATE TABLE `dhdc_tmp_village` (
  `HOSPCODE` varchar(5) NOT NULL,
  `VID` varchar(8) NOT NULL,
...
-- ----------------------------
-- Records of dhdc_tmp_village
-- ----------------------------

-- ----------------------------
-- Table structure for dhdc_tmp_women
-- ----------------------------
DROP TABLE IF EXISTS `dhdc_tmp_women`;
CREATE TABLE `dhdc_tmp_women` (
  `HOSPCODE` varchar(5) NOT NULL,
  `PID` varchar(15) NOT NULL,
...
-- ----------------------------
-- Table structure for err_zall_
-- ----------------------------
DROP TABLE IF EXISTS `err_zall_`;
CREATE TABLE `err_zall_` (
  `HOSPCODE` varchar(5) NOT NULL DEFAULT '',
...
-- ----------------------------
-- Records of err_zall_
-- ----------------------------

-- ----------------------------
-- Table structure for err_zhos_
-- ----------------------------
DROP TABLE IF EXISTS `err_zhos_`;
CREATE TABLE `err_zhos_` (
  `HOSPCODE` varchar(5) NOT NULL,
...
-- ----------------------------
-- Table structure for sys_count_import_file_
-- ----------------------------
DROP TABLE IF EXISTS `sys_count_import_file_`;
CREATE TABLE `sys_count_import_file_` (
...
-- ----------------------------
-- Records of sys_count_import_file_
-- ----------------------------
...
-- ----------------------------
INSERT INTO `sys_version` VALUES ('20160330-patch');
...
#2558
call err_anc_b(2558);
call err_charge_opd_b(2558);
call err_chronic_b(2558);
call err_chronicfu_b(2558);
call err_dental_b(2558);
call err_diagnosis_opd_b(2558);
call err_disability_b(2558);
call err_drugallergy_b(2558);
call err_drug_opd_b(2558);
call err_epi_b(2558);
call err_fp_b(2558);
call err_functional_b(2558);
call err_icf_b(2558);
call err_labfu_b(2558);
call err_labor_b(2558);
call err_ncdscreen_b(2558);
call err_newborn_b(2558);
call err_newborncare_b(2558);
call err_nutrition_b(2558);
call err_person_b(2558);
call err_postnatal_b(2558);
call err_prenatal_b(2558);
call err_procedure_opd_b(2558);
call err_provider_b(2558);
call err_rehabilitation_b(2558);
call err_service_b(2558);
call err_specialpp_b(2558);
call err_village_b(2558);
...
,(SELECT BYEAR from cbyear WHERE CURDATE() BETWEEN DATE1 AND DATE2) as 'BYEAR' # แฟ้มสะสม
...
UPDATE err_chronic  SET BYEAR = ''  WHERE ERR_DATE = 'Y';
...
,CONCAT(
	...
	,if(s.SEQ is NULL or s.PID is NULL or s.HOSPCODE is NULL,'SERVICE,','')
	,if(t.PROVIDER is NULL or trim(t.PROVIDER)='','PROVIDER,','')
	#,if(pd.PROVIDERTYPE is NULL or pd.PROVIDERTYPE not in ('02','06'),'PROVIDERTYPE,','')

) as ERR_CODE
	,t.HOSPCODE,t.PID,t.SEQ,s.SEQ as SERVICE_SEQ,t.DATE_SERV,t.DENTTYPE,t.SERVPLACE,t.PROVIDER,pd.PROVIDERTYPE,date(t.D_UPDATE) as 'DUPDATE'
...
FROM dental t 
		LEFT JOIN service s on t.HOSPCODE = s.HOSPCODE AND t.PID = s.PID AND t.SEQ = s.SEQ
		LEFT JOIN person p on t.HOSPCODE = p.HOSPCODE AND t.PID = p.PID
		LEFT JOIN provider pd ON t.HOSPCODE = pd.HOSPCODE AND t.PROVIDER = pd.PROVIDER
		LEFT JOIN chospital_amp hos ON hos.hoscode = t.HOSPCODE
...
UPDATE err_disability  SET BYEAR = ''  WHERE ERR_DATE = 'Y';
...
UPDATE err_drugallergy  SET BYEAR = ''  WHERE ERR_DATE = 'Y';
...
,CONCAT(
	...
	,if(t.FPTYPE in (1,2,3,4,7),if(p.SEX <> 2,'SEX,',''),'')
	,if(t.FPTYPE in (6),if(p.SEX <> 1,'SEX,',''),'')
) as ERR_CODE
	,t.HOSPCODE	,t.PID,p.SEX,t.SEQ,t.DATE_SERV,t.FPTYPE,date(t.D_UPDATE) as 'DUPDATE'
...
-- ----------------------------
-- Procedure structure for err_home
-- ----------------------------
DROP PROCEDURE IF EXISTS `err_home`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `err_home`()
BEGIN
UPDATE sys_check_process t set t.fnc_name = 'err_home' , t.time = NOW();
DELETE FROM home WHERE HOSPCODE NOT IN (SELECT hoscode from chospital_amp);
DROP TABLE IF EXISTS err_home;
CREATE TABLE  err_home AS (
SELECT * FROM
(SELECT SQL_BIG_RESULT
	'HOME' as FILE
...
,CONCAT(
	if(LENGTH(trim(t.HOSPCODE)) <> 5 ,'HOSPCODE,','')
	,if(t.HOUSETYPE NOT IN (1,2,3,4,5,8,9) ,'HOUSETYPE,','')
	,if(t.HOSPCODE not in (SELECT h.hoscode  from chospital_amp h),'HOSPCODE,','')
	,if(CONCAT(t.HOSPCODE,t.HID) <> CONCAT(t2.HOSPCODE,t2.HID),'REPEAT','') 
) as ERR_CODE
	,t.HOSPCODE	,t.HID,t.HOUSETYPE,t.HOUSE as 'ADDR',t.VILLAGE,t.TAMBON,t.AMPUR,date(t.D_UPDATE) as 'DUPDATE'

	 
FROM home t 
		LEFT JOIN home t2  on t.HOSPCODE = t2.HOSPCODE AND t.HID = t2.HID
) d 
...
UPDATE err_home  SET BYEAR = ''  WHERE ERR_DATE = 'Y';
...
SELECT h.hoscode as 'HOSPCODE'
,'HOME' as 'FILE' 
,(SELECT COUNT(*) FROM home t WHERE t.HOSPCODE = h.hoscode) as 'TOTAL'
,(SELECT COUNT(*) FROM err_home t WHERE t.HOSPCODE = h.hoscode) as 'ERR'
,CURDATE() as 'DUPDATE'
FROM chospital_amp h
);
...
UPDATE sys_files SET qc = 100-ROUND((SELECT count(*) from err_home)*100/(SELECT count(*) from home),2)
,note1 = 'y' , note2 = CURDATE() WHERE file_name = 'home';
UPDATE sys_files set qc = 0.00 WHERE qc is NULL;
...
-- ----------------------------
-- Procedure structure for err_home_b
-- ----------------------------
DROP PROCEDURE IF EXISTS `err_home_b`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `err_home_b`(IN `BYEAR` varchar(4))
BEGIN
	SET @byear = byear;
	SET @date1 = (SELECT c.DATE1 FROM cbyear c WHERE c.BYEAR = @byear);
	SET @date2 = (SELECT c.DATE2 FROM cbyear c WHERE c.BYEAR = @byear) ;
UPDATE sys_check_process t set t.fnc_name = 'err_home_b' , t.time = NOW();

REPLACE INTO err_zall (

	SELECT  h.hoscode as 'HOSPCODE',UPPER('home') as 'FILE',@byear as 'BYEAR'
		,COUNT(t.HOSPCODE) as 'TOTAL'
		,(SELECT COUNT(*) FROM err_home e WHERE e.HOSPCODE = h.hoscode AND e.BYEAR = @byear) as 'ERR'
		,(SELECT COUNT(*) FROM err_home e WHERE e.HOSPCODE = h.hoscode AND e.ERR_DATE = 'Y') as 'ERR_DATE'
		,CURDATE() as 'DUPDATE'
	FROM chospital_amp h

	LEFT JOIN home t on t.HOSPCODE = h.hoscode 
	GROUP BY h.hoscode 
); # end insert
...
,CONCAT(
	...
	,t.HOSPCODE 	,t.PID ,p.SEX,t.GRAVIDA,t.LMP,t.BDATE,t.BRESULT,t.BPLACE,t.BTYPE
	,t.BDOCTOR,t.LBORN,t.SBORN,date(t.D_UPDATE) as 'DUPDATE'
...
UPDATE err_labor  SET BYEAR = ''  WHERE ERR_DATE = 'Y';
...
UPDATE err_newborn  SET BYEAR = ''  WHERE ERR_DATE = 'Y';
...
CALL err_person_typearea_cup; # PREPARE repeat typearea with one cid.
...
,CONCAT(
	...
	,if((t.BIRTH is NULL) or (t.BIRTH > CURDATE()) or (t.BIRTH < (CURDATE()-INTERVAL 150 YEAR)) ,'PE1109,','')
	,if(t.TYPEAREA not BETWEEN 1 and 5,'PE1140,','')
	,if(t.DISCHARGE ='' or t.DISCHARGE IS NULL,'PE1141,','')
	,if(hos.hoscode is NULL,'PE9201,','')
	,if(t.NATION='099' AND t.DISCHARGE=9 AND t.TYPEAREA in (1,3),if(mod11(t.CID)=0,'CID,',''),'')
...
UPDATE err_person  SET BYEAR = ''  WHERE ERR_DATE = 'Y';
...
-- ----------------------------
-- Procedure structure for err_person_typearea_cup
-- ----------------------------
DROP PROCEDURE IF EXISTS `err_person_typearea_cup`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `err_person_typearea_cup`()
BEGIN

TRUNCATE err_person_typearea_cup;

REPLACE INTO err_person_typearea_cup  (

SELECT  
p.CID
,COUNT(p.HOSPCODE) as NUM_HOSP
,GROUP_CONCAT(p.HOSPCODE SEPARATOR ',') AS HOSPCODE 
...
,CONCAT(
	...
	,t.HOSPCODE	,t.PID,p.SEX,t.GRAVIDA,t.BDATE,t.PPCARE,t.PPRESULT,date(t.D_UPDATE) as 'DUPDATE'
...
,CONCAT(
	...
	,t.HOSPCODE	,t.PID ,p.SEX,t.GRAVIDA,t.LMP,t.VDRL_RESULT,t.HB_RESULT,t.HIV_RESULT,t.THALASSEMIA,date(t.D_UPDATE) as 'DUPDATE'
...
UPDATE err_provider  SET BYEAR = ''  WHERE ERR_DATE = 'Y';
...
UPDATE err_village  SET BYEAR = ''  WHERE ERR_DATE = 'Y';

...
-- ----------------------------
INSERT INTO `sys_version` VALUES ('20160315');
...
BEGIN 
set @ds1:='2015-4-1',@ds2:='2016-3-31';
...
select p.hospcode
	...
	,a.vaccinetype
	,p.birth
        ,timestampdiff(year,p.birth,CURRENT_DATE())Age_y
	,a.date_serv
	,if(timestampdiff(year,p.birth,a.date_serv)<=5,'Y',null) OK
from person p
left join epi a on a.pid=p.pid and a.hospcode=p.hospcode and a.vaccinetype=035
where p.birth between '2010-4-1' and '2011-03-31'
